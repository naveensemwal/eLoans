        ...
        try {
            ...
            if (!result.cancelled) {
                if (type == 'back')
                    ...
                    updateForm({ ...formData, aadharFrontImage: result.uri });
            }
                ...
                <View style={styles.imageContainer}>
                    {
                        formData.aadharFrontImage ?
                            <View style={{ flex: 1 }}>
                                <ImageBackground source={{ uri: formData.aadharFrontImage }} style={{ width: '100%', height: '100%' }}>
                                    <View style={{ flex: 1, flexDirection: "row-reverse" }}>
                                        <Icon
                                            ...
                                            color='transparent'
                                            size={25}
                                            onPress={() => updateForm({ ...formData, aadharFrontImage: '' })}
                                        />
                                    </View>
                                </ImageBackground>
                            </View>
                            ...
                            <View style={{ alignItems: "center", paddingTop: 40 }} activeOpacity={1}>
                                ...
                                <Text style={{ fontFamily: 'Roboto', fontWeight: "bold" }}>Upload Aadhar Front Image</Text>
                            </View>
                    }
                </View>
                <View style={styles.imageContainer}>
                    {
                        formData.aadharBackImage ?
                            <View style={{ flex: 1 }}>
                                <ImageBackground source={{ uri: formData.aadharBackImage }} style={{ width: '100%', height: '100%' }}>
                                    <View style={{ flex: 1, flexDirection: "row-reverse" }}>
                                        <Icon
                                            reverse
                                            name='ios-close-circle-outline'
                                            ...
                                            color='transparent'
                                            size={25}
                                            onPress={() => updateForm({ ...formData, aadharBackImage: '' })}
                                        />
                                    </View>
                                </ImageBackground>
                            </View>
                            ...
                            <View style={{ alignItems: "center", paddingTop: 40 }} activeOpacity={1}>
                                ...
                                <Text style={{ fontFamily: 'Roboto', fontWeight: "bold" }}>Upload Aadhar Back Image</Text>
                            </View>
                    }
                </View>
            </View>
            <View style={styles.nextButtonContainer}>
                <Button title="Next" onPress={() => props.navigation.navigate('CapturePAN')} />
            </View>
        </View>
    )
}
